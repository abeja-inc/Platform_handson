...
def handler(context):
    ...
    trainval = DetectionDatasetFromAPI(trainval_dataset, transform=SSDAugmentation(min_dim, MEANS))
    test = DetectionDatasetFromAPI(test_dataset, transform=SSDAugmentation(min_dim, MEANS))
